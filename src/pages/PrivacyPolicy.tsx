      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <motion.div className="mt-16 text-center glass-panel rounded-2xl p-10" {...fadeUp}>
            ...
            <a href="mailto:privacy@inclinedplane.com" className="inline-flex items-center gap-2 bg-gradient-orange text-primary-foreground px-6 py-2.5 rounded-lg text-sm font-medium hover:opacity-90 transition-opacity glow-orange">
              <Mail className="w-4 h-4" />
              privacy@inclinedplane.com
            </a>
          </motion.div>
        </div>
      </section>
